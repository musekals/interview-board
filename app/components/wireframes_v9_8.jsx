...
function ProfileScreen({ state }) {
  ...
  return (<div>
    {/* [v9.8] "편집" → /me/edit (profile-edit 화면으로 이동) */}
    <div style={{ padding: "12px 16px", display: "flex", justifyContent: "space-between", borderBottom: "1px solid #EEEDEA" }}><span style={{ fontSize: 14, color: "#888780" }}>← 뒤로</span>{isMe && <span style={{ fontSize: 14, color: "#534AB7", fontWeight: 600, cursor: "pointer" }}>편집 →</span>}</div>
...
function ProfileEditScreen({ state }) {
  ...
  return (<div>
    {/* 상단 바 — 취소 / 제목 / 저장 */}
    <div style={{ padding: "12px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #EEEDEA", background: "#fff" }}>
      <span style={{ fontSize: 14, color: "#888780", cursor: "pointer" }}>취소</span>
      <span style={{ fontSize: 15, fontWeight: 700, color: "#2C2C2A" }}>프로필 편집</span>
      <span style={{
        fontSize: 14,
...
function OperatorSignOffScreen({ state }) {
  ...
  return (<div>
    <div style={{ padding: "12px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #EEEDEA" }}>
      ...
      <span style={{ fontSize: 14, fontWeight: 600, color: "#2C2C2A" }}>{isSignOff ? "운영자 사임" : "운영 종료 요청"}</span>
...
function IssuePublishScreen({ state }) {
  ...
  return (<div>
    {/* 헤더 — 타이틀 + 현재 상태 배지 */}
    <div style={{ padding: "14px 16px 8px", borderBottom: "1px solid #EEEDEA" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
        <div style={{ fontSize: 18, fontWeight: 700, color: "#2C2C2A" }}>운영자 › {headerTitle}</div>
